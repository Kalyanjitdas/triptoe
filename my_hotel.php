...
@page { margin: 0; }
	...
	$sql ="select * from roombook where email = '$mail' ";
	...
	?>
		<header>
			...
			<address >
				<p>WELCOMHOTEL THE SAVOY,</p>
				<p>Library Chowk, 248179<br>Mussoorie,<br> India</p>
				<p>(+94) 65 222 44 55</p>
			</address>
			<span>
			<!-- <img alt="" src="assets/img/sun.png"> -->
				<p style="font-weight: 900;font-size:26px; margin-left:-10%; font-family: Times New Roman;">
				WELCOMHOTEL <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;THE SAVOY</p >		
			</span>
		</header>
		<article>
			<h1></h1>
		...
		<aside>
			...
			<div >
				<p align="center">Email :- info@WELCOMHOTEL THE SAVOY.com || Web :- www.WELCOMHOTEL THE SAVOY.com || Phone :- +94 65 222 44 55 </p>
			</div>
		</aside>
	</body>
</html>
